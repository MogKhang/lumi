...
sealed class MediaItem {
  ...
  MediaItem copyWith({
    ...
    return MediaItem(
      ...
      grandparentYear: grandparentYear ?? this.grandparentYear,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (grandparentYear != null) 'grandparentYear': grandparentYear,
...
_BaseFields _parseBaseFields(Map<String, dynamic> json) {
  ...
  return (
    ...
    grandparentYear: flexibleInt(json['grandparentYear']),
...
final class PlexMediaItem extends MediaItem {
  ...
  factory PlexMediaItem.fromJson(Map<String, dynamic> json) {
    ...
    return PlexMediaItem(
      ...
      grandparentYear: base.grandparentYear,
