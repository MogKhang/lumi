...
abstract class PlayerBase with PlayerStreamControllersMixin implements Player {
  ...
  ///
  /// Optimistically advances the reported position to [position] before the
  /// platform seek resolves, so rapid repeated seeks accumulate visually
  /// instead of snapping back between calls. Rolls back if the seek fails.
  @protected
