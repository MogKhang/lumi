...
class SleepTimerService extends ChangeNotifier {
  ...
  /// Arm the sleep timer to fire when the currently playing video reaches its
  /// end. Unlike [startTimer], no periodic timer runs — playback completion is
  /// reported externally via [notifyVideoCompleted].
  ...
  /// If armed via [armEndOfVideo], fires the completion callback and resets the
  /// mode. Safe to call unconditionally — does nothing when end-of-video mode
  /// is not armed.
