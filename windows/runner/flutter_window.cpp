...
static constexpr wchar_t kWindowPlacementKey[] = L"Software\\Lumi";
...
// ---------------------------------------------------------------------------
// Native fullscreen (lumi/window method channel)
//
...
void FlutterWindow::RegisterWindowChannel() {
  ...
  window_channel_ = std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
      messenger, "lumi/window", &flutter::StandardMethodCodec::GetInstance());
