...
MpvPlayerPlugin::MpvPlayerPlugin(flutter::PluginRegistrarWindows* registrar)
  ...
  method_channel_ = std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
      registrar->messenger(), "com.lumi/mpv_player", &flutter::StandardMethodCodec::GetInstance());
  ...
  event_channel_ = std::make_unique<flutter::EventChannel<flutter::EncodableValue>>(
      registrar->messenger(), "com.lumi/mpv_player/events", &flutter::StandardMethodCodec::GetInstance());
