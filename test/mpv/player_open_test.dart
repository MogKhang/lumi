...
import 'package:lumi/mpv/player/platform/player_android.dart';
import 'package:lumi/mpv/player/player_native.dart';
  ...
  group('player open', () {
    test('ExoPlayer clears stale Dart track state before opening new media', () async {
      await _withMockChannels(
        methodChannelName: 'com.lumi/exo_player',
        eventChannelName: 'com.lumi/exo_player/events',
        testBody: () async {
    ...
    test('MPV clears stale Dart track state before opening new media', () async {
      await _withMockChannels(
        methodChannelName: 'com.lumi/mpv_player',
        eventChannelName: 'com.lumi/mpv_player/events',
        testBody: () async {
